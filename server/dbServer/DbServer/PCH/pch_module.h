...
// ServerEngine 우산 모듈은 사용 불가 - import DbServer; 로 대체

#pragma once

#pragma warning(disable: 5028)

// DbServer 기본 PCH (pch_serverEngine.h + DbUserPtr 등 DbServer 전용 타입)
...
// DB 관련 헤더 (SP_*.h에서 사용 - 모듈보다 먼저 정의 필요)
