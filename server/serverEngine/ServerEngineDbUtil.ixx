...
export module ServerEngineDbUtil;

// DbUtil은 기존 헤더 기반 설계를 유지하되, .cpp에서는 include 없이 import로 사용할 수 있도록 모듈에서 재정의/노출한다.
export struct DbUtil
{
