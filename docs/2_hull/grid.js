class Grid {
    ...
    ['wave'](a, b) {
        var c = a['length'];
        var d = [
            b[0x0] === 0x0 ? 0x0 : WAVE / b[0x0],
            b[0x1] === 0x0 ? 0x0 : WAVE / b[0x1],
            b[0x2] === 0x0 ? 0x0 : WAVE / b[0x2],
            b[0x3] === 0x0 ? 0x0 : WAVE / b[0x3]
        ];
        var e = 0x0;
        for (e = c; e--;) {
            var f = a[e];
            if (f['team'] === 0x0)
                this['wave0'](f['x'], f['y'], f['vx'], f['vy'], d[0x0]);
            else if (f['team'] === 0x1)
                this['wave1'](f['x'], f['y'], f['vx'], f['vy'], d[0x1]);
            else if (f['team'] === 0x2)
                this['wave2'](f['x'], f['y'], f['vx'], f['vy'], d[0x2]);
            else if (f['team'] === 0x3)
                this['wave3'](f['x'], f['y'], f['vx'], f['vy'], d[0x3]);
        }
    }
    ['update']() {
        var a = 0x0;
