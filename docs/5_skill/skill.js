...
class Skill_attack extends Skill {
    ['onAct'](c, d, e) {
        ...
        if (g['life'] < 0x0)
            g['life'] = 0x0;
        g['tryStun'](e, d);
        e['push'](new Event(0x0, 0xa, null, null, f['x'], f['y'], g['x'], g['y']));
    }
}
class Skill_electricShock extends Skill {
    ['onAct'](c, d, e) {
        var f = c;
        var g = this['target'];
        if (!g || g['life'] <= 0x0 || f['life'] <= 0x0) {
        ...
        g['tryElectricShock'](e, ELECTRICSHOCK_DURATION, c, [], c);
    }
}
...
class Skill_heal extends Skill {
    ...
    ['onAct'](c, d, e) {
        ...
        e['push'](new Event(0x1, 0xa, null, null, f['x'], f['y'], g['x'], g['y']));
    }
}