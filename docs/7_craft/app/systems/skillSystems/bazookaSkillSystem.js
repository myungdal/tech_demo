class BazookaSkillSystem extends System {
    ...
    ['onAction'](a, b, d, f, g) {
        ...
        j['x'] = h['x'];
        j['y'] = h['y'];
        var k = g['attachComponent'](i, ExplosionEffectComponent['componentId']);
        k['power'] = f['skillAttribute']['power'];
        k['max_duration'] = k['duration'] = ConstAttribute['EXPLOSION_DURATION'];
        k['team'] = b['team'];
        k['characterType'] = b['type'];
    }
}