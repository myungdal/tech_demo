class MovingAttackSkillSystem extends System {
    ['init'](a) {
        this['includeComponent'](CharacterComponent['componentId'])['includeComponent'](EnemyComponent['componentId'])['includeComponent'](MovingAttackSkillComponent['componentId'])['exceptComponent'](MovingSkillMotionComponent['componentId'])['exceptComponent'](ElectricShockEffectComponent['componentId'])['exceptComponent'](StunEffectComponent['componentId'])['exceptComponent'](RunawayEffectComponent['componentId'])['exceptComponent'](DyingEffectComponent['componentId']);
        return super['init'](a);
    }
    ['update'](a, b) {
    ...
    ['onAction'](a, b, c, d) {
        ...
        if (f['characterAttribute']['dodge'] > Math['random']())
            return;
        var g = d['attachComponent'](c['target'], DamageComponent['componentId']);
        if (g) {
            g['power'] = 0x0;
            g['range'] = 0x0;
            g['stun_chance'] = 0x0;
        } else {
            g = d['getComponent'](c['target'], DamageComponent['componentId']);
        }
        if (g) {
            if (g['range'] > 0x0) {
                g['power'] += c['skillAttribute']['power'];
                g['range'] = Math['max'](g['range'], c['skillAttribute']['damageRange']);
            } else if (c['skillAttribute']['damageRange'] > 0x0) {
                g['power'] = c['skillAttribute']['power'];
                g['range'] = c['skillAttribute']['damageRange'];
            } else {
                g['power'] += c['skillAttribute']['power'];
                g['range'] = 0x0;
            }
            g['stun_chance'] = 0x1 - (0x1 - g['stun_chance']) * (0x1 - c['skillAttribute']['stun_chance']);
            g['team'] = b['team'];
            g['characterType'] = b['type'];
        }
    }
}