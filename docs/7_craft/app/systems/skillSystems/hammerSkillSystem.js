class HammerSkillSystem extends System {
    ...
    ['onAction'](a, b, c, d) {
        ...
        var h = d['attachComponent'](c['target'], StunEffectComponent['componentId']);
        if (h)
