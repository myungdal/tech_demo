class VirusSkillSystem extends System {
    ...
    ['onAction'](a, b, c, d) {
        ...
        if (f['characterAttribute']['dodge'] > Math['random']())
            return;
        var g = d['attachComponent'](c['target'], VirusEffectComponent['componentId']);
        if (g) {
            g['power'] = c['skillAttribute']['power'];
            g['duration'] = ConstAttribute['VIRUS_DURATION'];
