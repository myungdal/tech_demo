...
#include "EntityTemplateData.h"

#include "Dom/JsonValue.h"
#include "Dom/JsonObject.h"


void UEntityTemplateData::Save(TSharedRef<TJsonWriter<>> jsonWriter) const
{
...
void UEntityTemplateData::Load(const TSharedRef<FJsonObject> dataObj)
{
