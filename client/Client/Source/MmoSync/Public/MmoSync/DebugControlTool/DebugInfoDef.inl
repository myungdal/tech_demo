...
// 기본 맵 데이터
// ========================================================================
DEBUG_VAR_DEF(DEFAULT_MAP_MAP_KIND, int, 0)                                     // 맵 종류 (0:던전, 1:필드)
DEBUG_VAR_DEF(DEFAULT_MAP_GRID_FACTOR, int, 7)                                  // 그리드 팩터 GRID_FLOW_CHUNK_MAP_SIZE_FACTOR = 4 이상으로 셋팅할 것
DEBUG_VAR_DEF(DEFAULT_MAP_CASTLE_CNT, int, 5)                                  // 성 개수
DEBUG_VAR_DEF(DEFAULT_MAP_NEST_CNT, int, 50)                                   // 둥지 개수
