...
#include "MmoSync/System/Grid/GridSystemBlockOnDead.h"

#include "MmoSync/Grid/MultiGrid.h"
#include "Packet/StaticData/Character/CharacterDoc.h"


GridSystemBlockOnDead::GridSystemBlockOnDead(Engine& engine, TimeStepUpdateCycle timeStepUpdateCycle, GameInstance& game)
	:
...
void GridSystemBlockOnDead::Update()
{
	if (Data().empty())
		return;
